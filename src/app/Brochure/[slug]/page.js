...
async function uploadWithFormData() {
  ...
  let bodyContent = new FormData();
   ...
   let response = await fetch(`${apiRoute}/addBrochure`, { method: "POST", body: bodyContent,  });
                    ...
                    <div className='row'>
                       ...
                       <div className="row">
                              ...
                              <div className="col-md-8">
                                  <div className="input-field"><Input disabled placeholder="" variant="soft" size="lg" style={{padding:'12px 15px',fontSize:'15px', textTransform:'uppercase'}} value={data.type} /></div>
                              </div>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                  ...
                                  <input type="file" name="images" onChange={onSelectFile} accept="application/pdf"   style={{opacity:'0'}}/> 
                                  </Button>
                                  </div>
                              </div>
                            </div>
                           ...
                           <div className='row'>
                              ...
                              <div className='col-md-4'>
                              <Link variant="outlined" color="error" style={{width:'100%', fontSize:'15px',padding:'10px', display:'inline-block', textAlign:'center',border:'1px solid #000',color:'#000'}} href="/Brochure">  Back </Link>
                              </div>
                               
                              <div className='col-md-4'>
                              <Button variant="contained" color="success" style={{width:'100%', fontSize:'15px',padding:'10px',textTransform:'capitalize'}} onClick={uploadWithFormData}> Update Brochure </Button>
                              </div>
                            </div>
