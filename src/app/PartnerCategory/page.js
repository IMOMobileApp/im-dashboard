...
export default function partnercategory(){
    return(
        <>
          <div className="container">
                   <div className="row">
                     <div className="col-md-12">
                       <div className='page-header'>Partners Category</div>
                     </div>
                     <div className="col-md-12" style={{marginBottom:'20px'}}>
                        <div className="row">
                            ...
                            <Button variant="contained" color="success" style={{padding:'10px 20px', fontSize:'13px', marginLeft:'10px'}}>
                              <Link href="/PartnerCategory/addCategory" style={{color:'#fff'}}><AddIcon /> Add Category</Link></Button>
                            </div>
                        </div>
                     </div>
                     <div className='col-md-12'>
                     ...
                     <Suspense fallback={<Loader/>}><PartnerTable /></Suspense>
                     </div>
                    </div>
                </div>
        </>
