                     ...
                     <div className="col-md-12" style={{marginBottom:'20px'}}>
                        <div className="row">
                            ...
                            <Button variant="contained" color="success" style={{padding:'10px 20px', fontSize:'13px', marginLeft:'10px'}}>
                              <Link href={`/InitiativeVideos/${params.slug}/addVideo`} style={{color:'#fff'}}><AddIcon /> Add Video Links</Link></Button>
                            </div>
                        </div>
                     </div>
                     
                     <div className="col-md-12" style={{marginBottom:'150px'}}>
                     <Suspense fallback={<Loader/>}><VideoTable videoId={params.slug}/></Suspense>
                     </div>
                    </div>
                </div>
  )
