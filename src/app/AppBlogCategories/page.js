          ...
          <div className="container">
                   <div className="row">
                     <div className="col-md-12">
                       <div className='page-header'>App Blog Categories</div>
                     </div>
                     <div className="col-md-12" style={{marginBottom:'20px'}}>
                        <div className="row">
                            ...
                            <Button variant="contained" color="success" style={{padding:'10px 20px', fontSize:'13px', marginLeft:'10px'}}>
                              <Link href="/AppBlogCategories/addcategory" style={{color:'#fff'}}><AddIcon /> Add Category</Link></Button>
                            </div>
                        </div>
                     </div>
                     <div className='col-md-12'>
                     ...
                     <Suspense fallback={<Loader/>}><BlogcategoryTable /></Suspense>
                     </div>
                    </div>
                </div>
        </>
