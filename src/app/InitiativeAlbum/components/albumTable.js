...
//console.log("first", userId);
  ...
  const changeBlogStatus = (event) => {
    ...
    formdata.append("initiativeId", props.albumId);
    ...
    fetch(`${apiRoute}/editalbumcat`, requestOptions)
                ...
                {visibleRows.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right" data-attr="">
                        <Link
                          href={`/InitiativeAlbum/${props.albumId}/${row.catId}`}
                        >
