...
myHeaders.append("Content-Type", "application/json");
  await fetch(`${apiRoute}/deletewebimage`, {
    // Adding method type
    method: "POST",
    headers: myHeaders,
    redirect: 'follow',
...
.then(fetchAllalbumImages())
  ...
  async function uploadWithFormData() {
    pendingPopup()
     ...
     let response = await fetch(`${apiRoute}/editalbumcat`, { method: "POST", body: bodyContent, });
          ...
          <div className="container">
                     <div className="row">
                       <div className='col-md-10'>
                         <h2> Initiative Images</h2>
                         <p>All Initiative Images</p>
                       </div>
                      </div>
 ...
 <div className="row">
                ...
                <div className="col-md-8">
                  ...
                  {galleryimages?.map((file, i)=>{
                    ...
                    <span style={{position:'absolute',top:'0',right:'10px',cursor:'pointer'}} onClick={()=>deleteGalleryImage(file.imageId)}>
 ...
 {/* -----------------------------------gallery---------------------------- */}
                              ...
                              <div className='row'>
                                ...
                                <div className='col-md-4'>
                                <Link variant="outlined" color="error" style={{width:'100%', fontSize:'15px',padding:'10px', display:'inline-block', textAlign:'center',border:'1px solid #000',color:'#000'}} href="/InitiativeCategory">  Cancel </Link>
                                </div>
                                <div className='col-md-4'>
                                <Link href={`/InitiativeImages/${params.slug}/addImages`} variant="contained" color="success" style={{width:'100%', fontSize:'15px',padding:'10px',textTransform:'capitalize', border:'1px solid #008000',color:'#000',display:'inline-block',color:'green',textAlign:'center'}} > Add Image </Link>
                                </div>
                              </div>
                                   {/*-------------------------------------------------------------------------------------------------------------- */}
                              </div>
