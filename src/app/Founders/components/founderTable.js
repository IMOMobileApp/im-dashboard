...
const headCells = [
  ...
  { id: "cat_email", numeric: true, disablePadding: false, label: "Type" },
  {
    id: "cat_sequence",
    numeric: true,
    disablePadding: false,
...
export default function FounderTable() {
  ...
  const changeCaretakerStatus = (event) => {
    ...
    formdata.append("linkedin", event.linkedin);
    ...
    fetch(`${apiRoute}/updatefounder`, requestOptions)
                ...
                {visibleRows.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right" data-attr="">
                        <Link href={`Founders/${row.founderId}`}>
