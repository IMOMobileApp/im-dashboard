  ...
  const [status, setStatus] = useState()
    ...
    useEffect(
      ()=>{
        ...
        fetch(`${apiRoute}/giftcatdetail`, requestOptions)
...
async function uploadWithFormData() {
  ...
  pendingPopup()
   ...
   bodyContent.append("catId", data.catId);
   ...
   let response = await fetch(`${apiRoute}/editgiftcat`, { method: "POST", body: bodyContent, });
...
//  let deleteResponse = await fetch(`${apiRoute}/deletechampion`, requestOptions)
        ...
        <div className="container">
                   ...
                   <div className="row">
                     <div className='col-md-10'>
                       ...
                       <p>Update Category info and extras.</p>
                     </div>
                       ...
                       {/*-------------------------------------------------------------------------------------------------------------------------- */}
                        <div className="row">
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                  <div className="input-field"><Textarea disabled={false} minRows={2} size="lg" variant="soft" placeholder="" value={shotDesc}
                            ...
                            <div className='row'>
                              ...
                              <div className='col-md-4'>
                              <Link variant="outlined" color="error" style={{width:'100%', fontSize:'15px',padding:'10px', display:'inline-block', textAlign:'center',border:'1px solid #000',color:'#000'}} href="/GiftCategories">  Back </Link>
                              </div>
                              {/* <div className='col-md-4'>
                              <Button variant="outlined" color="error" style={{width:'100%', fontSize:'15px',padding:'10px', textTransform:'capitalize'}} onClick={deleteChampion}>  Delete Champion </Button>
                              </div> */}
                              <div className='col-md-4'>
                              <Button variant="contained" color="success" style={{width:'100%', fontSize:'15px',padding:'10px', textTransform:'capitalize'}} onClick={uploadWithFormData}> Update Category </Button>
                              </div>
                            </div>
