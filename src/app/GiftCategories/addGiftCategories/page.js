...
//console.log("first", userId);
  ...
  async function uploadWithFormData() {
    pendingPopup()
     ...
     let response = await fetch(`${apiRoute}/addgiftcat`, { method: "POST", body: bodyContent, });
                         ...
                         {/*-------------------------------------------------------------------------------------------------------------------------- */}
                          <div className="row">
                              ...
                              <div className='row'>
                                ...
                                <div className='col-md-4'>
                                <Link variant="outlined" color="error" style={{width:'100%', fontSize:'15px',padding:'10px', display:'inline-block', textAlign:'center',border:'1px solid #000',color:'#000'}} href="/GiftCategories">  Cancel </Link>
                                </div>
                                <div className='col-md-4'>
