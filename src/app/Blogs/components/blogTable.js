                ...
                {visibleRows.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right" data-attr="Name">
                        {row.blog_title}
                      </TableCell>
                      <TableCell align="right" data-attr="Description">
                        {row.short_desc}
                      </TableCell>
                      <TableCell align="right" data-attr="Published">
                        <Switch
                      ...
                      <TableCell align="right" data-attr="Date">{`${new Date(
                        row.createdAt
                      ).getDate()}/${
                        new Date(row.createdAt).getMonth() + 1
                      }/${new Date(row.createdAt).getFullYear()}`}</TableCell>
                      <TableCell align="right" data-attr="Action">
                        <Link href={`Blogs/${row.blogId}`}>
