...
const headCells = [
  ...
  { id: 'cat_published',  numeric: true, disablePadding: false, label: 'DOB', },
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  <TableRow hover role="checkbox" aria-checked={isItemSelected}
                    ...
                    <TableCell align="right" data-attr="">{row.mobile}</TableCell>
                    <TableCell align="right" data-attr="">{row.DOB}</TableCell>
                    ...
                    <TableCell align="right" data-attr=""><Link href={`Certificates/${row.challengeId}`}><span className="dashboard-table-icon"><RemoveRedEyeIcon /></span></Link></TableCell>
                  </TableRow>
                );
              })}
